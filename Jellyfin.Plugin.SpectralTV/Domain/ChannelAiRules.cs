...
public static class ChannelAiRules
{
    private static readonly Dictionary<string, ChannelAiRuleDefinition> Rules = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["spectraltv-reality"] = new(
            ...
            ChannelCatalogMode.Mixed),
        ["spectraltv-news"] = new("News programming only (News genre preferred).", ChannelCatalogMode.TvOnly),
        ["spectraltv-past-tense-news"] = new(
        ...
        ["spectraltv-comedy"] = new(
            ...
            ChannelCatalogMode.Mixed),
        ["spectraltv-game-shows"] = new("Game shows only.", ChannelCatalogMode.Mixed),
        ["spectraltv-education"] = new("Educational TV and documentaries (History, Discovery, science, nature).", ChannelCatalogMode.Mixed),
        ["spectraltv-youtube"] = new("Only content from the Jellyfin TV library named YouTube.", ChannelCatalogMode.TvOnly),
        ["spectraltv-creature"] = new(
        ...
        ["spectraltv-hero"] = new(
            ...
            ChannelCatalogMode.Mixed),
        ["spectraltv-funny"] = new("Comedian-led movies and TV.", ChannelCatalogMode.Mixed),
        ["spectraltv-holiday"] = new(
            ...
            ChannelCatalogMode.Mixed),
        ["spectraltv-parody"] = new("Parody music videos; use fine-tune keywords or artists.", ChannelCatalogMode.MusicVideoOnly),
        ["spectraltv-rap"] = new("Rap and hip hop music videos; use fine-tune keywords or artists.", ChannelCatalogMode.MusicVideoOnly),
        ["spectraltv-music-video"] = new("General music videos; use fine-tune keywords or artists.", ChannelCatalogMode.MusicVideoOnly),
    };
    ...
    {
        ["spectraltv-flashback"] = new ChannelCatalogYearConstraints
        {
            MinYear = 1970,
            MaxYear = 2010,
            UseFirstEpisodeYearForSeries = true
        },
        ["spectraltv-retro"] = new ChannelCatalogYearConstraints
        {
            MinYear = 1910,
            MaxYear = 1969,
            UseFirstEpisodeYearForSeries = true
    ...
    {
        ["spectraltv-flashback"] = new ChannelCatalogGenreConstraints
        {
            ExcludedGenreKeywords = new[] { "Crime", "Cop", "Police", "Detective", "Game Show", "Game-Show", "GameShow" }
        },
        ["spectraltv-retro"] = new ChannelCatalogGenreConstraints
        {
            ExcludedGenreKeywords = new[] { "Crime", "Cop", "Police", "Detective", "Game Show", "Game-Show", "GameShow" }
        },
        ["spectraltv-open-swim"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-reality"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-crime"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-comedy"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-funny"] = new ChannelCatalogGenreConstraints
        {
            RequiredGenreKeywords = new[] { "Comedy" },
            RequiredPlotKeywords = new[]
            {
        ...
        ["spectraltv-game-shows"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-education"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-creature"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-hero"] = new ChannelCatalogGenreConstraints
        {
        ...
        ["spectraltv-news"] = new ChannelCatalogGenreConstraints
        {
    ...
    {
        ["spectraltv-past-tense-news"] = new ChannelCatalogLibraryConstraints
        {
            LibraryName = "Past Tense News"
        },
        ["spectraltv-youtube"] = new ChannelCatalogLibraryConstraints
        {
            LibraryName = "YouTube"
        }
    };
    ...
    {
        ["spectraltv-parody"] = "music-videos",
        ["spectraltv-rap"] = "music-videos",
        ["spectraltv-music-video"] = "music-videos",
        ["spectraltv-youtube"] = "youtube-pbs",
        ["spectraltv-game-shows"] = "winning-game-shows",
        ["spectraltv-education"] = "get-learneded",
        ["spectraltv-past-tense-news"] = "past-tense-news",
        ["spectraltv-open-swim"] = "kids-all-day",
        ["spectraltv-flashback"] = "classic-cable",
        ["spectraltv-retro"] = "classic-cable",
        ["spectraltv-creature"] = "movie-marathon",
        ["spectraltv-hero"] = "movie-marathon",
        ["spectraltv-holiday"] = "holiday-channel",
        ["spectraltv-comedy"] = "slappy-comedy",
    };
    ...
    /// <summary>
    /// Extracts the first spectraltv tag from channel filter JSON.
    /// </summary>
    ...
    public static bool IsExcludedFromAi(string? libraryTag)
        => string.Equals(libraryTag, "spectraltv-news", StringComparison.OrdinalIgnoreCase);
