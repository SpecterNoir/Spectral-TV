...
/// <summary>
/// Shared System.Text.Json settings for SpectralTV (case-insensitive property names).
/// </summary>
public static class SpectralTvJson
{
    /// <summary>
    /// Default serializer options for SpectralTV JSON read/write.
    /// </summary>
