...
public class PluginConfiguration : BasePluginConfiguration
{
    ...
    /// <summary>
    /// When true, SpectralTV emits verbose developer logs (especially for AI channel building).
    /// </summary>
    public bool DebugLogging { get; set; }

    public string? CommercialLibraryId { get; set; }

    public string? CommercialLibraryTag { get; set; } = "spectraltv-commercial";
    ...
    public string Binarygeek119LogoSetUrl { get; set; } =
        "https://github.com/binarygeek119/open-channel-logos/tree/spectraltv2";
    ...
    /// SpectralTV merges each channel's <c>latLonQuery</c>, forces <c>kiosk=true</c>, and optionally sets <c>wide</c> at capture time.
    /// </summary>
...
public class AiSettings
{
    ...
    /// <summary>
    /// When true, a weekly scheduled task tags library items with spectraltv-* channel tags using channel rules.
    /// </summary>
    public bool AutoTagChannelsWeekly { get; set; }

    /// <summary>
    /// When true, AI catalog browse queries Jellyfin using spectraltv-* tags written by auto-tagging (faster manifests).
    /// </summary>
