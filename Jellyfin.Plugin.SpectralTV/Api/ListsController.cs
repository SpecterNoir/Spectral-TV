...
/// <summary>
/// SpectralTV list registry backed by Jellyfin playlists.
/// </summary>
[ApiController]
[Route("SpectralTV/api/lists")]
[Authorize(Policy = Policies.RequiresElevation)]
public class ListsController : ControllerBase
{
    private readonly SpectralTvListService _lists;

    public ListsController(SpectralTvListService lists)
    {
        _lists = lists;
    }
    ...
    [HttpPost]
    public async Task<ActionResult<SpectralTvList>> Create([FromBody] SpectralTvListCreateDto dto, CancellationToken cancellationToken)
    {
        try
        {
    ...
    [HttpPut("{id:guid}")]
    public async Task<ActionResult<SpectralTvList>> Update(Guid id, [FromBody] SpectralTvListUpdateDto dto, CancellationToken cancellationToken)
    {
    ...
    private object MapListSummary(SpectralTvList list)
    {
        return new
        {
            list.Id,
