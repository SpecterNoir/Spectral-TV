...
public class SpectralTvDbContext : DbContext
{
    public SpectralTvDbContext(DbContextOptions<SpectralTvDbContext> options)
        : base(options)
    {
    }
    ...
    public DbSet<SpectralTvList> SpectralTvLists => Set<SpectralTvList>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SpectralTvList>(entity =>
        {
