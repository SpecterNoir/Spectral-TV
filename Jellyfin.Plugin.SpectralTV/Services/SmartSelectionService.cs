...
public class SmartSelectionService
{
    ...
    public SmartSelectionService(SpectralTvDbContext db, JellyfinCatalogService catalog)
    {
        _db = db;
        _catalog = catalog;
    }
        ...
        CancellationToken cancellationToken)
    {
        return candidate.Kind switch
        {
            ...
            SlotCandidateKind.Playlist when candidate.SpectralTvListId.HasValue =>
                await _catalog.ResolvePlaylistAsync(candidate.SpectralTvListId.Value, channel, anchor, scheduleDate, slotIndex, cancellationToken),
