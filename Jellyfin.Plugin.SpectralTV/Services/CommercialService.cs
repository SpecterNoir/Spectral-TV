...
public class CommercialService
{
    ...
    public CommercialService(SpectralTvDbContext db, ILibraryManager libraryManager, JellyfinCatalogService catalog, IChapterManager chapterManager)
    {
        _db = db;
    ...
    {
        var config = Plugin.Instance?.Configuration;
        var tag = config?.CommercialLibraryTag ?? "spectraltv-commercial";
