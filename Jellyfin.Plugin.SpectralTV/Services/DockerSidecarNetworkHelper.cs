...
/// <summary>
/// Resolves Docker network attachment for SpectralTV sidecars (Playwright, WeatherStar) when Jellyfin runs in a container.
/// </summary>
public static class DockerSidecarNetworkHelper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        logger.LogInformation(
            "Jellyfin container {ContainerRef} will share network namespace with SpectralTV sidecar",
            containerRef);
...
/// <summary>
/// Docker network attachment for a SpectralTV sidecar container.
/// </summary>
