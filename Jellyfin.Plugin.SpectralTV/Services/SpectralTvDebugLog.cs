...
/// <summary>
/// Gates verbose developer logging behind the SpectralTV debug setting.
/// </summary>
public static class SpectralTvDebugLog
{
    private const string AiLogTemplate = "[SpectralTV AI] {Detail}";

    /// <summary>
    /// Gets whether verbose SpectralTV debug logging is enabled.
    /// </summary>
