...
public class PluginServiceRegistrator : IPluginServiceRegistrator
{
    ...
    public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
    {
        ...
        serviceCollection.AddScoped<SpectralTvListService>();
        ...
        serviceCollection.AddScoped<SpectralTvChannelTaggingService>();
        ...
        serviceCollection.AddSingleton<SpectralTvChannelAutoTaggingTask>();
        serviceCollection.AddSingleton<IScheduledTask>(sp => sp.GetRequiredService<SpectralTvChannelAutoTaggingTask>());
